...
uint8_t nodeDeviceEUI[8] = {0xAC, 0x1F, 0x09, 0xFF, 0xFE, 0x08, 0xE7, 0x60};
uint8_t nodeAppEUI[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
uint8_t nodeAppKey[16] = {0x74, 0x65, 0xAE, 0xD2, 0x48, 0x0E, 0xDB, 0xBD, 0xAE, 0x7D, 0xBC, 0x64, 0x96, 0xB6, 0x37, 0x98};
...
void loop()
{
  send_always = 0;                    // Make this value 1 if you want continuous transmission and 0 if only when triggered.
  float x = 0;
  float y = 0;
  float z = 0;
