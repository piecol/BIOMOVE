...
void setup()
{
  pinMode(WB_IO1, OUTPUT); //@pico initialize pin 1 to use with logic analyzer
...
void loop()
{
  digitalWrite(WB_IO1, HIGH); //@pico use GPIO1 as a trigger on a channel of the logic analyzer 
	shtc3_read_data();
